      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`flex items-center justify-between transition-all duration-300 ${
            ...
            >
              <div className={`p-2 bg-gradient-to-r from-[#2F64FF] to-[#00BFFF] rounded-xl transition-all duration-300 group-hover:scale-110 ${
                isScrolled ? 'shadow-md' : 'shadow-lg'
              }`}>
                <Brain className={`text-white transition-all duration-300 ${
                  isScrolled ? 'h-5 w-5' : 'h-6 w-6'
                }`} />
              </div>
              <span className={`font-bold bg-gradient-to-r from-[#2F64FF] to-[#00BFFF] bg-clip-text text-transparent transition-all duration-300 ${
