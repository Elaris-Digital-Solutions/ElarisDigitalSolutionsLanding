...
const contactMethods = [
  {
    ...
    value: "contact@elaris.ai",
    link: "mailto:contact@elaris.ai",
  ...
  },
  {
    ...
    value: "+34 911 123 456",
    link: "tel:+34911123456",
      ...
      >
        ...
        <div className="grid grid-cols-1 gap-12 max-w-4xl mx-auto">
          ...
          >
            ...
            {/* Contact Methods consolidated below the form */}
        ...
        {/* Google Maps placeholder under the consolidated column */}
        <motion.div
          className="mt-20 max-w-7xl mx-auto px-6"
        >
          <div className="w-full h-[500px] rounded-2xl overflow-hidden border border-white/[0.15] bg-white/[0.04]">
            <iframe
              title="Mapa - Universidad Peruana de Ciencias Aplicadas (UPC), Lima, Perú"
              className="w-full h-full"
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
              src="https://www.google.com/maps?q=Universidad%20Peruana%20de%20Ciencias%20Aplicadas%20(UPC),%20Lima,%20Peru&output=embed"
            />
          </div>
          <p className="mt-3 text-center text-white/70 text-sm">
            Ubicación: Universidad Peruana de Ciencias Aplicadas (UPC), Lima, Perú
          </p>
        </motion.div>
